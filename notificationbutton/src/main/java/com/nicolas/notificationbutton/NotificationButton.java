package com.nicolas.notificationbutton;
...
/**
 * Created by Nicolas on 2017/3/22.
 * 按键右上角带数字提示button
 */
public class NotificationButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    private void initProperty(Context context, AttributeSet attributeSet) {
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.NotificationButton);
        redCircleSize = typedArray.getDimension(R.styleable.NotificationButton_circleSize, 20);
        circleColor = typedArray.getColor(R.styleable.NotificationButton_circleBgColor, Color.RED);
        textColor = typedArray.getColor(R.styleable.NotificationButton_textColor, Color.WHITE);
        paint = new Paint();
        paint.setAntiAlias(true);
        typedArray.recycle();
    }
